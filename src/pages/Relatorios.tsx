...
const Relatorios = () => {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      doc.setFontSize(20);
      doc.text("GestClini — Relatório Financeiro", 14, 22);
      doc.setFontSize(10);
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text(`GestClini · Página ${i} de ${pageCount}`, pageWidth / 2, doc.internal.pageSize.getHeight() - 10, { align: "center" });
      }

      doc.save("GestClini_Relatorio.pdf");
