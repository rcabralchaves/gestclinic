...
import logoGestClinic from "@/assets/logo-gestclinic.png";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b bg-card/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={logoGestClinic} alt="GestClinic" className="h-9 object-contain" />
          </div>
      ...
      <section className="py-16 sm:py-20 border-t">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-heading font-bold">Por que escolher GestClinic?</h2>
          </div>
      ...
      <footer className="border-t py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            <img src={logoGestClinic} alt="GestClinic" className="h-7 object-contain" />
          </div>
          <p>© {new Date().getFullYear()} GestClinic. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
